...
export default function Home() {
  return (
    ...
    >
      ...
      <h1
        className={`${playfairDisplay.className} max-w-5xl text-center text-4xl sm:text-5xl md:text-6xl lg:text-7xl xl:text-8xl font-bold text-indigo-900 dark:text-indigo-200 leading-tight`}
      >
