...
const styles = {
  ...
  notification: {
    ...
    badge:
      "flex items-center gap-2 py-2 px-3 rounded-full bg-slate-200 dark:bg-slate-700",
    ...
    arrow:
      "w-5 h-5 sm:w-4 sm:h-4 group-hover:translate-x-1 transition-transform duration-200",
  },
  ...
  statistics: {
    ...
    value:
      "text-2xl sm:text-3xl lg:text-4xl font-bold text-slate-900 dark:text-white",
