...
const styles = {
  ...
  image:
    "animate-pulse w-full h-auto max-w-md lg:max-w-lg xl:max-w-xl drop-shadow-2xl",
  bottomGradient:
...
const Button = ({ text, onClick, variant }: ButtonProps) => (
  ...
  >
    <span className={`${ibmPlexMono.className} ${styles.buttonText}`}>
      {text}
    </span>
    {variant === "secondary" && (
      <div className={styles.secondaryButtonOverlay} />
    )}
  </button>
);
