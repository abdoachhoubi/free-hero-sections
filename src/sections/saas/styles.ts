export const styles = {
  ...
  mainContainer:
    'relative z-10 flex flex-col lg:flex-row items-center h-full px-4 pt-[14dvh] lg:px-[10%] lg:pt-0',
  contentContainer: 'flex-1 w-full space-y-4 lg:space-y-2 xl:space-y-6 text-center lg:text-left',
  availabilityBadge:
  ...
  availabilityText:
    'text-green-600 dark:text-green-400 text-sm lg:text-xs xl:text-base font-medium',
  headline:
    'text-3xl lg:text-4xl xl:text-5xl 2xl:text-6xl font-bold leading-relaxed lg:leading-tight',
  headlineGradient:
  ...
  description:
    'text-violet-950 dark:text-violet-50/80 text-sm xl:text-base 2xl:text-lg max-w-2xl lg:max-w-lg leading-relaxed mx-auto lg:mx-0 font-light',
  buttonGroup: 'flex flex-col sm:flex-row gap-4 justify-center lg:justify-start pt-4',
  primaryButton:
    'group relative cursor-pointer bg-violet-950 dark:bg-violet-100 text-violet-50 dark:text-violet-950 hover:bg-violet-950/90 px-8 lg:px-6 xl:px-8 py-4 lg:py-3 xl:py-4 text-base lg:text-sm xl:text-base rounded-xl transition-all duration-300 hover:scale-105 hover:shadow-2xl hover:shadow-violet-50/25',
  secondaryButton:
    'group relative cursor-pointer border-2 border-violet-950/30 dark:border-violet-50/30 text-violet-950 dark:text-violet-50 hover:border-violet-950/50 hover:dark:border-violet-50/50 px-8 sm:px-10 py-4 lg:py-3 xl:py-4 text-base lg:text-sm xl:text-base bg-violet-50/5 backdrop-blur-sm rounded-xl transition-all duration-300 hover:scale-105 hover:bg-violet-50/10',
  ...
  trustIndicators:
    'flex flex-wrap justify-center lg:justify-start gap-6 lg:gap-4 xl:gap-6 pt-8 lg:pt-4 xl:pt-6 text-violet-950/60 dark:text-violet-50/60 text-sm lg:text-xs xl:text-base',
  trustItem: 'flex items-center space-x-2',
  trustDot: 'w-1 h-1 bg-violet-950/40 dark:bg-violet-50/40 rounded-full',
  visualContainer:
    'h-[80%] lg:w-[50%] xl:h-[80%] relative flex flex-1 justify-center lg:justify-end mt-8 lg:mt-0',
  glowEffect:
